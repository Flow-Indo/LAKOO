    ...
    <div className="px-4 py-4 bg-white">
      ...
      {post.group && (
        <Link
          ...
          className="flex items-center gap-3 p-3 mb-3 bg-[#F7F7F7] hover:bg-[#F0F0F0] rounded-lg transition-colors"
        >
      ...
      {post.event && (
        <Link
          ...
          className="flex items-center gap-3 p-3 mb-3 bg-[#FFF7ED] hover:bg-[#FFEDD5] rounded-lg transition-colors"
        >
      ...
      <button className="flex items-center gap-2 mb-6 text-sm text-gray-600 hover:text-gray-900">
