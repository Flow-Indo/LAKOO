...
export class AdminController {
  ...
  getPaymentAnalytics = asyncHandler(async (req: Request, res: Response) => {
    ...
    const [totalPayments, statusCounts, methodCounts, revenueData] = await Promise.all([
  ...
  // Settlement Records
  getSettlementRecords = asyncHandler(async (req: Request, res: Response) => {
  ...
  // Gateway Logs
  getGatewayLogs = asyncHandler(async (req: Request, res: Response) => {
