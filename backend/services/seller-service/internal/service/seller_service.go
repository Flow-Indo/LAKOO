...
func NewSellerService(repo *repository.SellerRepository, s3Uploader *storage.S3Uploader) *SellerService {
	return &SellerService{repo: repo, s3Uploader: s3Uploader}
}
