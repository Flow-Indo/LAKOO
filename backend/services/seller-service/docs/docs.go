...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.SellerProfileResponseDTO"
                        }
                    },
                    "404": {
        ...
        "/{sellerId}/bank": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.SellerBankResponseDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Bank info to update",
                        "name": "bankInfo",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateBankAccountPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/{sellerId}/business": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Business info to update",
                        "name": "businessInfo",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateBusinessInfoPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/{sellerId}/products": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by product status (e.g., draft, active)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.ListSellerProductsResponseDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.CreateSellerProductPayload"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/types.SellerProductResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateSellerProductPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/{sellerId}/products/{productId}/images": {
            "post": {
        ...
        "/{sellerId}/products/{productId}/publish": {
            "patch": {
        ...
        "/{sellerId}/products/{productId}/unpublish": {
            "patch": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UpdateShopInfoPayload"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.SellerStatsOverviewResponseDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/types.VerificationStatusResponseDTO"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/{sellerId}/verification/documents": {
            "get": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/types.UploadSellerDocumentPayload"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/types.SellerDocumentResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "types.CreateSellerProductPayload": {
            "type": "object",
            "properties": {
                "category_id": {
                    "type": "string"
                ...
                "images": {
                    "description": "expects JSON array/object",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "types.ListSellerProductsResponseDTO": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer"
        ...
        "types.SellerDocumentResponseDTO": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "types.SellerProductResponseDTO": {
            "type": "object",
            "properties": {
                "category_id": {
                    "type": "string"
        ...
        "types.SellerProfileResponseDTO": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "types.SellerStatsOverviewResponseDTO": {
            "type": "object",
            "properties": {
                "avg_rating": {
                    "type": "number"
        ...
        "types.UpdateBankAccountPayload": {
            "type": "object",
            "properties": {
                "bank_account_name": {
                    "type": "string"
        ...
        "types.UpdateBusinessInfoPayload": {
            "type": "object",
            "properties": {
                "address": {
                    "type": "string"
        ...
        "types.UpdateSellerProductPayload": {
            "type": "object",
            "properties": {
                "category_id": {
                    "type": "string"
        ...
        "types.UploadSellerDocumentPayload": {
            "type": "object",
            "properties": {
                "document_number": {
                    "type": "string"
        ...
        "types.VerificationStatusResponseDTO": {
            "type": "object",
            "properties": {
                "seller_id": {
                    "type": "string"
